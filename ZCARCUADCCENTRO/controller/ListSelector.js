sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("app.inetum.ZCARCUADCENTRO.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias app.inetum.ZCARCUADCENTRO.controller.ListSelector
			 */
			 ...
			 * @return {app.inetum.ZCARCUADCENTRO.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
